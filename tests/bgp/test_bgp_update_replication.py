...
def test_bgp_update_replication(
    ...
    for interval in duthost_intervals:
        ...
        for _ in range(20):
            # Inject 10000 routes
            route_injector.announce_routes_batch(generate_routes(num_routes=NUM_ROUTES, nexthop=route_injector.ip, is_ipv6=is_ipv6))
            ...
            # Remove routes
            route_injector.withdraw_routes_batch(generate_routes(num_routes=NUM_ROUTES, nexthop=route_injector.ip, is_ipv6=is_ipv6))
