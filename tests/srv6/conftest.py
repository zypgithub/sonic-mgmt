import pytest
from tests.srv6.srv6_helper import SRv6Packets
...
from tests.srv6.srv6_helper import create_srv6_locator, del_srv6_locator, create_srv6_sid, del_srv6_sid, MyLocators, \
    MySIDs
