...
PRIVATE_BRANCHES_TO_ENABLE_BUG_HANDLER_LIST = ["smart-switch-master", "master_rc", "master_rc_chamelleon", "master_spc6", "master_rc_integration", "master_rc_trixie", "multi-asic"]
