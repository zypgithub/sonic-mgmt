...
def check_transceiver_status(dut, asic_index, interfaces, first_ports_in_split, xcvr_skip_list, port_list_with_flat_memory):
    """
    ...
    check_transceiver_dom_sensor_basic(dut, asic_index, first_ports_in_split, xcvr_skip_list, port_list_with_flat_memory)
    check_transceiver_dom_sensor_details(dut, asic_index, first_ports_in_split, xcvr_skip_list, port_list_with_flat_memory)
