...
def reboot(duthost, localhost, reboot_type='cold', delay=10,
           timeout=0, wait=0, wait_for_ssh=True, wait_warmboot_finalizer=False,
           warmboot_finalizer_timeout=0, reboot_helper=None, reboot_kwargs=None,
           return_after_reconnect=False, plt_reboot_ctrl_overwrite=True, safe_reboot=False,
           check_intf_up_ports=False, wait_for_bgp=False,  wait_for_ibgp=True,
    ...
    # Workaround
    logger.info('Waiting for ansible connection timeout')
    time.sleep(61)
