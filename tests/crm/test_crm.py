...
def test_crm_route(duthosts, enum_rand_one_per_hwsku_frontend_hostname, enum_frontend_asic_index,
    ...
    expected_min_used = crm_stats_route_used + total_routes
    ...
    expected_max_used = crm_stats_route_used
...
def _get_interface_neighbor_and_port(duthost, tbinfo, dut_interface, nbrhosts):
    ...
    neighbor_interface = f'po{lacp_num}' if lacp_num else neighbor_interface.replace('Ethernet', 'eth')
