...
class QosBase:
    ...
    Common APIs
    """
    SUPPORTED_T0_TOPOS = ["t0", "t0-56", "t0-56-po2vlan", "t0-64", "t0-64-256", "t0-c256", "t0-116", "t0-118", "t0-35",
    ...
    SUPPORTED_T1_TOPOS = ["t1-lag", "t1-64-lag", "t1-56-lag", "t1-backend", "t1-28-lag", "t1-32-lag", "t1-lag-c224o8",
                          "t1-isolated-d28u1"]
