...
from tests.common.utilities import get_ipv4_loopback_ip, get_ipv6_loopback_ip, get_dscp_to_queue_value, find_egress_queue, \
...
class TestQoSSaiDSCPQueueMapping_IPIP_Base():
    ...
    def _run_test(self,
        ...
        outer_src_pkt_ip = test_params.get("outer_src_ip", DUMMY_OUTER_SRC_IP_V6 if is_ipv6_only else DUMMY_OUTER_SRC_IP)
