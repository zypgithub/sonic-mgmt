...
def test_invalid_setup_name():
    ...
    for add_char in invalid_add_chars:
        ...
        cmd = f'{SCRIPT_PATH} create --setup_name \"{invalid_setup_name}\"\
            ...
            --dut_hwsku \"ACS-SN6600\" --chip_type \"SPC6\" --custom_links_path \"/auto/mtrsysgwork/ytzur/link.json\" --dbs_to_run_path \"/auto/mtrsysgwork/ytzur/db.json\"'
...
def required_params_test():
    ...
    for param in required_params:
        cmd = f'{SCRIPT_PATH} create --setup_name \"test\" --topology_type \"canonical\" --base_version \"/auto/sw_system_release/sonic/master_SPC6-latest-internal-sonic-mellanox.bin\" --topology \"ptf-any\" --custom_tarball_name \"SONIC_CANONICAL-sonic-mgmt_develop.db.1.tgz\" --branch \"develop\" --dut_name \"new_test_dut\" --dut_hwsku \"ACS-SN6600\" --chip_type \"SPC6\" --custom_links_path \"/auto/mtrsysgwork/ytzur/link.json\" --dbs_to_run_path \"/auto/mtrsysgwork/ytzur/db.json\"'
