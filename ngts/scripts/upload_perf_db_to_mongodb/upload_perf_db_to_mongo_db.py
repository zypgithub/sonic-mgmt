...
def test_upload_perf_db(topology_obj, setup_name):
    try:
        ...
        passing_sandbox_validation_tests, failing_sandbox_validation_tests = do_sandbox_testing(tests_path_specific_values_dict, topology_obj, setup_name)
...
def do_sandbox_testing(tests_path_specific_values_dict, topology_obj, setup_name):
    ...
    for test_path, test_specific_values_str in tests_path_specific_values_dict.items():
        ...
        updated_test_name = f"{setup_name}_{updated_test_name}"
        ...
        if err_file_exists:
            ...
            logger.error(f"Test {test_path} failed sandbox validation, please check the error file {test_db_sandbox_testing_err_path}")
        else:
