...
class JulietScaleoutSwitch(JulietSwitch):
    ...
    def _init_constants(self):
        ...
        self.cluster_app_nmx_controller = {'addition-info': None, 'app-id': 'nmx-c-nvos', 'app-ver': None, 'capabilities': 'sm, gfm, fib, gw-api', 'components-ver': None, 'reason': '', 'status': 'ok'}
        self.cluster_app_nmx_telemetry = {'addition-info': None, 'app-id': 'nmx-telemetry', 'app-ver': None, 'capabilities': 'ib-telemetry', 'components-ver': None, 'reason': '', 'status': 'ok'}
        self.cluster_app = {
