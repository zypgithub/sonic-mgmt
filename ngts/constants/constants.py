...
class MarsConstants:
    ...
    TOPO_ARRAY = ("t0-56-po2vlan", "t0", "t1-lag", "t1-28-lag", "ptf32", "t0-64", "t1-64-lag", "t0-56", "t0-56-o8v48",
                  "t0-120", "t1-56-lag", "t0-28", "dualtor", "dualtor-64", "dualtor-aa")
...
class GnmiConsts:
    ...
    STREAM_PERFORMANCE_TOTAL_DURATION = 250
