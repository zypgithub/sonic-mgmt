...
@pytest.mark.parametrize("platform_component_with_clear", ["bmc", "fpga"], indirect=True)
def test_component_install(engines, devices, topology_obj, test_api, platform_component_with_clear):
    """
    ...
    if component_name == PlatformConsts.FW_FPGA.lower():
        platform = Platform()
