...
def test_install_platform_firmware(engines, devices, test_name, topology_obj, nv_command, clear_asic_files, verify_no_kernel_errors, show_platform_initial_state):
    """
