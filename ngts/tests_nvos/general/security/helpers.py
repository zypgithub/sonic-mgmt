...
def setup_certs_for_tests(certs_dirname_prefix: str, certs_names: List[str], engines, dut_hostname, import_to_dut=False, scp_player=None) -> Tuple[str, List[CertInfo]]:
