class PwhConsts:
    ...
    ERR_RANGE = 'Error: Valid range is {} - {}'
    ERR_VALUE_LESS_THAN_MIN = "Error: {} is less than the minimum of {}"
    ERR_VALUE_GREATER_THAN_MAX = "Error: {} is greater than the maximum of {}"
    ERR_EXP_WARN_LEQ_EXP = 'expiration-warning should be equal or smaller than expiration'
    ERR_INTEGER_EXPECTED = "Error: '{}' is not of type 'integer'"
