...
TOPO_ARRAY = ("t0", "t1-lag", "ptf32", "t0-64", "t0-64-256", "t0-c256", "t0-isolated-d2u254s1", "t1-lag-c224o8", "t1-32-lag", "t1-64-lag", "t1-isolated-d254u2s1", "t0-56", "t0-56-po2vlan", "t0-56-o8v48", "t1-isolated-d224u8", "t0-isolated-d128u128s1")
REBOOT_TYPES = {
    "reboot": "reboot",
