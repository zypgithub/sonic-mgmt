...
def main():
    ...
    retry_call(test_server.run, fargs=["sudo timedatectl set-timezone Asia/Jerusalem"], tries=3, delay=5, logger=logger)
...
def get_docker_default_tag(docker_name):
    latest = "latest"
    default_list = {'docker-ngts': 'DEV_air_2_0-1.3.48'}
